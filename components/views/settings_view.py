...
from components.calculations import EMISSION_FACTORS, COST_FACTORS, calculate_detailed_emissions, safe_float
...
def render_settings_view():
    ...
    with tab_factors:
        ...
        with st.form("factors_form"):
            ...
            with cf1:
                f_price = st.number_input("Carbon Credit Market Price (₹/tonne)", min_value=1.0, value=safe_float(st.session_state.get("form_inputs", {}).get("credit_price"), 38.0), step=1.0)
