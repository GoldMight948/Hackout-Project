...
def render_sidebar():
  ...
  with st.sidebar:
    ...
    org_icon = feather_icon("box", color="#F59E0B" if is_demo else "#5A8766", size=24, margin_right=10)
      ...
      <div class="workspace-card" style="margin-bottom: 8px;">
        ...
        <div style="display: flex; align-items: center;">
          ...
          <div>
            ...
            <div style="font-size: 0.78rem; color: var(--text-muted);">{user_name} &bull; <span style="color: #5A8766; font-weight: 700;">{user_role}</span></div>
          </div>
        </div>
      </div>
    ...
    <div style="color: var(--text-muted); margin-top: 2px;">Statutory carbon audit filing due in 45 days.</div>
      ...
      <div style="background: var(--bg-subtle); border: 1px solid var(--border-color); border-radius: 10px; padding: 10px 12px; font-size: 0.8rem; margin-bottom: 8px;">
    <div style="font-weight: 700; color: #5A8766; display: flex; align-items: center;">{check_icon} Q3 Solar Credit Verified</div>
